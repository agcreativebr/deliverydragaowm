			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">		
					<nav class="main_nav_underline">
						<ul>
							<li class="<?php echo @$home ?>"><a href="index.php"><img src="images/icons/white/home.png" alt="" title="" /><span>Home</span></a></li>
							<li class="subnav opensubnav <?php echo @$menu_pessoas ?>" onclick="$('#sub_pessoas').show(); $('#sub_cadastros').hide(); $('#sub_financeiro').hide()"><img src="images/icons/white/users.png" alt="" title="" /><span>Pessoas</span></li>
							<li class="subnav opensubnav <?php echo @$menu_cadastros ?>" onclick="$('#sub_cadastros').show(); $('#sub_pessoas').hide(); $('#sub_financeiro').hide();"><img src="images/icons/white/more.png" alt="" title="" /><span>Cadastros</span></li>
							<li class="subnav opensubnav <?php echo @$menu_financeiro ?>" onclick="$('#sub_financeiro').hide(); $('#sub_pessoas').hide(); $('#sub_financeiro').show();"><img src="images/icons/white/financeiro.png" alt="" title="" /><span>Financeiro</span></li>
			...
			<div class="panel panel-right panel-reveal">
				<div class="user_login_info">
					...
					<div class="user_thumb">
						...
						<div class="user_avatar"><img src="images/perfil/<?php echo $foto_usuario ?>" alt="" title="" /></div>       
					</div>

					<nav class="user-nav">
						<ul>
							<li class="<?php echo @$configuracoes ?>"><a href="#" data-popup=".popup-config" class="open-popup"><img src="images/icons/white/settings.png" alt="" title="" /><span>Configurações</span></a></li>
			            ...
			            <div class="page-content">
						    ...
						    <div class="navbarpages" style="background:#3e3e3e">
								<div class="navbar_left">
									<div class="logo_text"><a href="index"><img src="../../img/foto-painel.png" alt="" title="" width="180px"/></a></div>
								</div>
