  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body" align="center">
       ...
       <?php if($id_usuario == ""){ ?>
        <p>Digite seu telefone abaixo (OBRIGATÓRIO)</p>
        
       <input onkeyup="buscarNome()" type="text" class="input telefone_user" name="telefone" id="telefone" required value="" placeholder="(79) 00000-0000" style="width:350px; text-align: center; border:0; margin-top: -15px; font-size:1.5rem">
       
       
       <hr>
       
       <div class="nome_user"> <input onclick="buscarNome()" type="text" class="input" name="nome" id="nome" required value="" placeholder="CLIQUE AQUI PARA COLOCAR SEU NOME" style="width:350px; text-align: center; border:2; font-size:1.1rem;"></div >
       </br>
     <?php }else{ ?>
       <div class="nome_user"> <input type="text" class="input" id="nome" value="" placeholder="Nome Cliente"  style="width:350px; text-align: center; border:2; font-size:1.1rem;"></div >
       <select class="input telefone_user" name="mesa" id="mesa" style="width:100px; text-align: center; border:0; margin-top: 15px; margin-bottom: 10px">
